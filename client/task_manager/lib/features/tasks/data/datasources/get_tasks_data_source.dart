...
class GetTaskDataSource implements BaseDataSource {
  final CustomHttpClient client;
  GetTaskDataSource({required this.client});

  @override
  Future<Either<Response, dynamic>> dataSourceMethod(dynamic requestModel) async {
    final Response response = await client.get(Uri.parse(AppUrls.TASKS()));
